...
from fanjiang.layers import DropPath, to_2tuple, trunc_normal_
...
class VisionTransformer(nn.Module):
    ...
    """
    def __init__(self, img_size=128, patch_size=3, stride=1, padding=1, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
...
class VitEncoder(VisionTransformer):
    def __init__(
        ...
        for i in self.out_indices:
            ...
            proj_layer = nn.Conv2d(dim, out_channels, kernel_size=1, padding=0)

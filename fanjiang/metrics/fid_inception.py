...
class InceptionV3(nn.Module):
    ...
    def __init__(self,
        ...
        if use_fid_inception:
            inception = fid_inception_v3(in_chans, load_fid_inception)
        else:
...
def fid_inception_v3(in_chans, load_ckpt=True):
    ...
    inception.Conv2d_1a_3x3 = BasicConv2d(in_chans, 32, kernel_size=3, stride=2)

    if load_ckpt:
        weight_name="Conv2d_1a_3x3.conv.weight"

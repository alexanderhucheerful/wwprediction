...
class _Resample2d(Function):
    ...
    def forward(ctx, input1, input2, kernel_size=1, bilinear= True):
        ...
        _C.resample2d_forward(input1, input2, output, kernel_size, bilinear)
        return output
    ...
    def backward(ctx, grad_output):
        ...
        _C.resample2d_backward(input1, input2, grad_output.data,
...
class Resample2d(Module):
    ...
    def forward(self, input1, input2):
        ...
        return _Resample2d.apply(input1_c, input2, self.kernel_size, self.bilinear)
